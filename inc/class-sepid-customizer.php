...
class Customizer {
	...
	public function __construct( $config = array()) {
		$this->config = apply_filters( 'sepid_customizer_filter', $config );
...
//		add_action( 'customize_register', array( $this, 'customize_modify' ) );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'sepid-customize', get_template_directory_uri() . '/assets/js/backend/customizer.js', array( 'jquery' ), '', true );
	}
	...
	public function enqueue_preview_scripts() {
		...
		wp_enqueue_script( 'sepid-customizer-preview', get_template_directory_uri() . '/assets/js/backend/customizer-preview.js', array( 'customize-preview' ), '', true );
	}
